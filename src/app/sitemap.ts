...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${BASE}/states`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.9 },
    { url: `${BASE}/carry-laws`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.8 },
