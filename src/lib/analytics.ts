...
// cookie consent on consent-gated sites — FirearmSelect's GA4 only loads
// after cookie consent acceptance, so events fired before consent become
// no-ops, not errors). Never sends user PII — only business identifiers
// (vendor names, geography, categories).
